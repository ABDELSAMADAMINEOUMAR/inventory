  ...
  function render(container) {
    ...
    <div class="fade-in">
      <div class="page-header">
        <div class="page-title" style="display:flex;align-items:center;gap:10px;"><h2>${t('page_expenses')}</h2><p>${I18n.choose('Track all business and import expenses', 'تتبع مصاريف العمل والاستيراد', 'Suivre toutes les dépenses professionnelles et d\'importation')}</p></div>
